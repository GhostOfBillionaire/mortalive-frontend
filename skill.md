...
Unhinged posts/comments remain isolated from the main feed unless a future explicit migration moves them. The `/unhinged` and `/unhinged/:postId` pages are rendered by the main Express server and are public/indexable.
